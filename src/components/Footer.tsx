      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-lg bg-zinc-200 text-zinc-700 transition-all hover:bg-blue-600 hover:text-white dark:bg-zinc-800 dark:text-zinc-300"
                aria-label="GitHub"
              >
                <svg
                  className="h-5 w-5"
        ...
        <div className="mt-8 border-t border-zinc-200 pt-8 dark:border-zinc-800">
          <p className="text-center text-sm text-zinc-600 dark:text-zinc-400">
            © {currentYear} DevBlog. Built with Next.js and Prisma. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
